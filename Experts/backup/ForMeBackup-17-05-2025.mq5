...
const ulong MagicNumberBuy  = 2025091901;
const ulong MagicNumberSell = 2025091902;
const ulong MagicNumberHelp = 2025091903;

//--- Inputs Https server api
const string TradeLogAPI_URL    = "https://your-server.com/api/save_trade";
const int WebRequestTimeout     = 10000;
...
// When we hit the target Close all positions
// Close trade
void CloseAll()
{
    // Hold new Position BUY temporary until other task finish
    buyState.sequence_active = true;

    // Hold new Position SELL temporary until other task finish
...
/// Prediction The Positons trading and current sisuation
...
void PredictNewPosition()
{
    ...
    /// Check Profit hit the target or not
    CheckProfitAndClose();
}
